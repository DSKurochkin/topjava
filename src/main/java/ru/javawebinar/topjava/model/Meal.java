...
@NamedQueries({
        @NamedQuery(name = Meal.GET, query = "SELECT m FROM Meal m LEFT JOIN FETCH m.user WHERE m.id=:id AND m.user.id=?1"),
        ...
        @NamedQuery(name = Meal.ALL_FILTERED, query = "SELECT m FROM Meal m WHERE m.user.id=?1  " +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String DELETE = "Meal.del";
    public static final String ALL = "Meal.getAll";
    public static final String ALL_FILTERED = "getBetweenHalfOpen";
